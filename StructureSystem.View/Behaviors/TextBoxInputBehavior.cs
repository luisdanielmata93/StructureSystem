...
namespace StructureSystem.View.Behaviors
{
    internal class TextBoxInputBehavior : Behavior<TextBox>
    {
        ...
        public static readonly DependencyProperty
            ValueProperty = DependencyProperty.Register("Value", typeof(decimal),
               typeof(TextBoxInputBehavior), new FrameworkPropertyMetadata()
               {
                   DefaultValue = decimal.Zero,
                   BindsTwoWayByDefault = true,
                   DefaultUpdateSourceTrigger = System.Windows.Data.UpdateSourceTrigger.PropertyChanged,
                   PropertyChangedCallback = new PropertyChangedCallback(ValuePropertyCallback)
               });
