...
{
   public class LosaViguetaBovedillaAzotea : FlooringMaterial
    {
        public LosaViguetaBovedillaAzotea()
        {
        ...
        {
            CargaMuerta = Impermeabilizante_ + MorteroPE_ + FirmePE_ + LosaPE_ + BovedillasPE_ + AplanadoPE_ + Instalaciones_ + CargaAdicionalPorColado_ + CargaAdicionalPorMortero_;
        }
